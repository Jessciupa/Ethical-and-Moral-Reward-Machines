...
class RewardMachine:
    def __init__(self, file):
        ...
        self._using_utilitarian = False
        self._using_act_deontology = False
    # Public methods -----------------------------------
    ...
    def step(self, u1, true_props, s_info, add_rs=False, env_done=False):
        ...
        # Returning the next RM state, RM reward, RM done flag, and an empty dictionary as additional information
        return u2, rew, done, {}
