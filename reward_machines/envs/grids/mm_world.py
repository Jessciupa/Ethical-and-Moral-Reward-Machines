...
class MoralMachineWorld:
    ...
    def _load_map(self):
        ...
        self.objects[(10,7)] = "c"
        self.objects[(10,1)] = "d"
        self.objects[(8,2)] = "o"  # Old Person
        self.objects[(3,6)] = "y"  # Young Person
        self.objects[(4,4)] = "g"  # Goal State
        self.objects[(4,1)] = "n"  # Collide
        self.objects[(7,1)] = "n"  # Collide
        self.objects[(4,7)] = "n"  # Collide
        self.objects[(7,7)] = "n"  # Collide
        self.objects[(1,4)] = "n"  # Collide
        self.objects[(10,4)] = "n" # Collide
        # Adding walls
    ...
    def _load_map_moral(self):
        ...
        self.morals = {}
        self.morals[(8,2)] = "Good(r)"  # Good (save 1)
        self.morals[(3,6)] = "Good(p)"  # Good (save 5)
        self.morals[(4,4)] = "Neutral"  # Neutral 
        self.morals[(4,1)] = "Bad"  # Bad
        self.morals[(7,1)] = "Bad"  # Bad 
        self.morals[(4,7)] = "Bad"  # Bad 
        self.morals[(7,7)] = "Bad"  # Bad 
        self.morals[(1,4)] = "Bad"  # Bad 
        self.morals[(10,4)] = "Bad" # Bad 